...
ALLOWED_HOSTS = ['23.88.103.149', 'wottan.mvilera.com.ve']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dacardioapp',                      # Or path to database file if using sqlite3.
        'USER': 'dacardioapp',                      # Not used with sqlite3.
        'PASSWORD': 'dacardioapp123',                  # Not used with sqlite3.
